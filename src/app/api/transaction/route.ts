...
export async function POST(request: Request) {
  ...
  const { fromAccountId, toAccountId, amount, description, fromAccountType, toAccountType } = await request.json();
  ...
  if (validatedData) {
    switch (true) {
      ...
      case ['Debit', 'Credit', 'Debt'].includes(fromAccountType) && toAccountType === 'SpendingCategory':
